...
DROP TRIGGER IF EXISTS update_debt_payoff_plans_updated_at ON debt_payoff_plans;
CREATE TRIGGER update_debt_payoff_plans_updated_at BEFORE UPDATE ON debt_payoff_plans
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_debt_items_updated_at ON debt_items;
