...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for pdfs" ON storage.objects FOR SELECT USING (bucket_id = 'pdfs');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for pdfs" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'pdfs');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for pdfs" ON storage.objects FOR UPDATE USING (bucket_id = 'pdfs');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for pdfs" ON storage.objects FOR DELETE USING (bucket_id = 'pdfs');`
    ];
